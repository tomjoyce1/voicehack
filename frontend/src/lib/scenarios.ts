export type Scenario = {
  ...
  presenting_line: string;
  hidden_diagnosis: string;
  difficulty: "Year 3" | "Year 4" | "Year 5" | "Finals";
  system: string;
  symptoms: string[];
  history: string[];
  red_flags: string[];
...
export const SCENARIOS: Scenario[] = [
  {
    ...
    presenting_line:
      "Doctor, I've got this awful crushing pain in my chest, it started about an hour ago.",
  ...
  },
  {
    ...
    presenting_line:
      "I can't catch my breath and my chest feels really tight, it's getting worse.",
    ...
    red_flags: ["Using accessory muscles", "Cannot complete sentences when severe"],
    required_questions: [
      "Onset and triggers",
      "Inhaler use",
      "Previous admissions",
  ...
  },
  {
    ...
    presenting_line:
      "I've had this belly ache since yesterday, but now it's really sore on the bottom right.",
  ...
  },
  {
    ...
    presenting_line:
      "Doctor, I had the worst headache of my life come on out of nowhere — it felt like I was hit on the back of the head.",
  ...
  },
  {
    ...
    presenting_line:
      "Every time I roll over in bed the room spins for about 20 seconds — it's terrifying.",
  ...
  },
  {
    ...
    presenting_line:
      "I've been coughing up green stuff for three days and I just feel awful, shaking with fever.",
  ...
  },
  {
    ...
    presenting_line:
      "Where am I, dear? My daughter brought me but I don't really know why...",
  ...
  },
  {
    ...
    presenting_line:
      "My left calf has been swollen and really tender since I got off the plane three days ago.",
